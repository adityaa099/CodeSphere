...
import { FiMail, FiLock, FiUser, FiArrowRight, FiCode } from 'react-icons/fi';
    ...
    <Container>
      <AuthCard>
        <Header>
          ...
          <p>Join CodeSphere to start executing code in the cloud</p>
        </Header>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Button type="submit" disabled={isLoading}>
            {isLoading ? 'Creating...' : 'Sign Up'} <FiArrowRight />
          </Button>
        </Form>
